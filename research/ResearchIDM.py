...
class ResearchIDM(BaseCogModResearch):
    def __init__(self, 
                 client, 
    ...
    def create_simulation(self):
        ...
        ego_agent = self.createIDMAgent(self.current_cogmod_agent_settings, loglevel=logging.ERROR)
    ...
    def onTick(self, tick):
        ...
        if self.scenario_status == ScenarioState.START:
            # if not self.isDriverChangedScenarioStart:
            #     cogmod_settings = DriverModifier.change_idm_settings_start_simulation(self.current_cogmod_agent_settings,
            #                                                                           self.ego_agent_df)
            ...
            #     self.isDriverChangedScenarioStart = True
            #     pass
